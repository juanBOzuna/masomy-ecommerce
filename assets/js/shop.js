      ...
      var htmlProductActual = `
        ...
        product.picture
                        ...
                        <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                            <ul class="list-unstyled">
                                <li class="open-rating-modal"  productId="${
                                  product.id
                                }" ><a class="btn btn-success text-white" href="#"><i class="far fa-heart"></i></a></li>
    ...
    addToCartLinks.forEach((link) => {
      link.addEventListener("click", function (event) {
        ...
        const productDiscount = parseFloat(
          link.getAttribute("productDiscount")
        );
...
document
  .getElementById("enviarCalificacionBtn")
  .addEventListener("click", function () {
    var selectedRating = document.querySelectorAll(
      "#ratingStars .text-warning"
    ).length;
    ...
    if (!userSession) {
      ...
      myHeaders.append("Authorization", "Bearer " + accessToken.token);
      ...
      fetch(`${serverUrl}/api/valorations/create`, requestOptions)
        ...
        .then((result) => {
          ...
          ).innerHTML = ` <input type="hidden" name="product_id" id="product_id_modal_calificar">
